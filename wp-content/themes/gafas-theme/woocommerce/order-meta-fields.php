...
<section class="checkout-fields-for-blocks">
	...
	<h6 class="additonal-information-title styled"><?php esc_html_e( 'Additional Information', 'checkout-fields-for-blocks' ); ?></h6>

	<ul class="additional-information-details" style="padding-inline-start: 10px;">

		<?php foreach ( $additional_fields as $field ) : ?>

		<li class="order" style="list-style-type: none; margin-left: 0;">
			
			<?php echo esc_html( $field['label'] ); ?>: <?php echo esc_html( $field['value'] ); ?>
		</li>
