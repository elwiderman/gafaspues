...
<?php
if (get_user_meta($user_id, 'quiero_factura_electronica', true)) :
	$val = get_user_meta($user_id, 'quiero_factura_electronica', true) ? 'Si' : 'No';
	echo '<strong>'.__('Si quieres la factura electronica -').':</strong> ' . $val;
endif;
?>
