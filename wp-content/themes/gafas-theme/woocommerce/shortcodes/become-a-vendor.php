...
<div id="yith-become-a-vendor" class="woocommerce shortcodes">
	...
	<div class="form-wrap form-vendor-regn">
		<form method="post" class="register">
			...
			<div class="form-row form-submit submit-wrapper">
				<?php wp_nonce_field( 'woocommerce-register' ); ?>
				<button type="submit" id="yith-become-a-vendor-submit" class="btn-dark" name="register">
