...
namespace CBFieldsVendor\Psr\Log\Test;

use CBFieldsVendor\Psr\Log\LoggerInterface;
use CBFieldsVendor\Psr\Log\LogLevel;
use CBFieldsVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('CBFieldsVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('CBFieldsVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('CBFieldsVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
