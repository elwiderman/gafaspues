...
namespace CBFieldsVendor\WPDesk\PluginBuilder\Builder;
...
use CBFieldsVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\CBFieldsVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
