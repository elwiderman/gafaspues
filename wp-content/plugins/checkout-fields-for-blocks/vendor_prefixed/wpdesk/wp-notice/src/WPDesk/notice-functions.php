...
if (!\function_exists('CBFieldsVendor\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    {
        $ajax_handler = new \CBFieldsVendor\WPDesk\Notice\AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('CBFieldsVendor\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('CBFieldsVendor\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    {
        return \CBFieldsVendor\WPDesk\Notice\Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('CBFieldsVendor\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('CBFieldsVendor\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    {
        return \CBFieldsVendor\WPDesk\Notice\Factory::notice($noticeContent, \CBFieldsVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
if (!\function_exists('CBFieldsVendor\wpdesk_wp_notice_info')) {
    /**
     * Creates Notice Info.
     *
...
if (!\function_exists('CBFieldsVendor\WPDeskWpNoticeError')) {
    /**
    ...
    {
        return \CBFieldsVendor\WPDesk\Notice\Factory::notice($noticeContent, \CBFieldsVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('CBFieldsVendor\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('CBFieldsVendor\WPDeskWpNoticeWarning')) {
    /**
    ...
    {
        return \CBFieldsVendor\WPDesk\Notice\Factory::notice($noticeContent, \CBFieldsVendor\WPDesk\Notice\Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('CBFieldsVendor\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('CBFieldsVendor\WPDeskWpNoticeSuccess')) {
    /**
    ...
    {
        return \CBFieldsVendor\WPDesk\Notice\Factory::notice($noticeContent, \CBFieldsVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
if (!\function_exists('CBFieldsVendor\wpdesk_wp_notice_success')) {
    /**
     * Creates Notice Success.
     *
...
if (!\function_exists('CBFieldsVendor\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    {
        return \CBFieldsVendor\WPDesk\Notice\Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('CBFieldsVendor\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *
